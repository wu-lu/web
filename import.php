  ...
  <div class="content">
    <div class = 'left_div' align="left" style="overflow:auto">
		<div style ="height:350px;">
			...
			//alert (import_commodity);
			
			//樹狀目錄
			if(<?php echo @$_SESSION['competence']?>=='3'){
				foldersTree = gFld("<?php echo @$_SESSION['father']?>",'welcome.php?ln='+ln);
			}else{
				foldersTree = gFld("<?php echo @$_SESSION['account']?>",'welcome.php?ln='+ln);
			}
			var aux='';
			var j=0;
			for(var i=0;i<store_count;i++){
				var show_store = "im.php?store_number="+store_number[i]+'&import_commodity='+import_commodity+'&ln='+ln;
				//auxi = insFld(foldersTree, gFld(store_name[i],show_store));
				insDoc(foldersTree, gLnk(0,store_name[i],show_store));
			}
    ...
    <div class = 'right_div' align="left">
		<iframe name="right" frameborder="0" class="room_select_show_iframe" scrolling="yes" style="height:700px;width:1100px;" align="left" src="welcome.php?ln=<?php echo $_GET['ln']?>">
		</iframe>
	</div>
<!-- end .content --></div>
<!-- end .container --></div>
